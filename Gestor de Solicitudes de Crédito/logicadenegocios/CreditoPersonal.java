...
public class CreditoPersonal extends Credito{
   ...
   * @param gastoFormalizacion representa los gastos para la formalizacion del crédito
   * @param COSTO_FORMALIZACION representa el porcentaje que se asigna por concepto de gastos de la formalizacion
   */
