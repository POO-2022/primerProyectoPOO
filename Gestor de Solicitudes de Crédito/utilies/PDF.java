...
public class PDF {
   ...
   * @param pNombreArchivo Nombre del pdf a crear, tambien se puede insertar una
   *                       direccion junto con el nombre,
   * 
  ...
  public void crearPDF(String pTexto, String pNombreArchivo) {
    try {
      ...
      PDPage pag = new PDPage(PDRectangle.LETTER); // pagina tama�o carta
      doc.addPage(pag);
      ...
      contenido.setFont(PDType1Font.TIMES_ROMAN, 12); // Fuente Times new Roman, tama�o 12
